            ...
            steps=[
                CommandStep(
                    ...
                    matrix=MatrixObject(
                        ...
                        adjustments=[
                            MatrixAdjustments(
                                matrix_with={"color": "blue", "shape": "triangle"},
                                skip=True,
                            ),
                            MatrixAdjustments(
                                matrix_with={"color": "green", "shape": "triangle"},
                                skip="look, hexagons are just better",
                            ),
                            MatrixAdjustments(
                                matrix_with={"color": "purple", "shape": "octagon"},
                            ),
                        ],
                    ),
                )
...
class TestMatrixDict(TestRunner):
    ...
    def test_multiple_adjustments(self):
        expected: CommandStepArgs = {
            ...
            "label": "{{matrix.color}} {{matrix.shape}}",
            "matrix": {
                "setup": {"color": ["green", "blue"], "shape": ["triangle", "hexagon"]},
                "adjustments": [
                    {"with": {"color": "blue", "shape": "triangle"}, "skip": True},
                    {
                        "with": {"color": "green", "shape": "triangle"},
                        "skip": "look, hexagons are just better",
                    },
